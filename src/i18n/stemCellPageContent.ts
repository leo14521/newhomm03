...
const ko: StemCellPageContent = {
  ...
  equipmentH2: "스마트프렙 2 (SmartPReP 2) · MCT(메타셀)",
  equipmentParas: [
...
const en: StemCellPageContent = {
  ...
  equipmentH2: "SmartPReP 2 · MCT (MetaCell)",
  equipmentParas: [
    "Developed from Harvard-linked research, SmartPReP 2 concentrates cells from whole blood or marrow with controlled centrifugation.",
  ...
  keyPointTitle: "Key point",
  keyPointParas: [
    "We use FDA/KFDA–cleared Smart M-cell2 technology with patented separation—no culture step, aiming to lower infection risk while harvesting stem cells, growth factors and leukocytes together.",
...
const ja: StemCellPageContent = {
  ...
  equipmentH2: "SmartPReP 2 · MCT（メタセル）",
  equipmentParas: [
    "ハーバード関連研究由来の分離濃縮システムで、全血・骨髄から細胞を精製します。",
  ...
  keyPointTitle: "Key point",
  keyPointParas: [
    "FDA/KFDA認可のSmart M-cell2と特許技術を使用。培養なしで感染リスクを抑え、幹細胞・成長因子・白血球などを同時に濃縮します。",
...
const zh: StemCellPageContent = {
  ...
  keyPointTitle: "Key point",
  keyPointParas: [
    "采用获 FDA/KFDA 许可的 Smart M-cell2 专利技术，无需培养，降低感染风险，同时富集干细胞、生长因子与白细胞等。",
...
const ru: StemCellPageContent = {
  ...
  equipmentH2: "SmartPReP 2 · MCT (MetaCell)",
  equipmentParas: [
    "Система концентрирования клеток из крови/костного мозга по протоколам, связанным с исследованиями Гарварда.",
  ...
  keyPointTitle: "Key point",
  keyPointParas: [
    "Только Smart M-cell2 с разрешениями FDA/KFDA, без культивирования — ниже риск инфекции, выше выход СК, факторов роста и лейкоцитов.",
